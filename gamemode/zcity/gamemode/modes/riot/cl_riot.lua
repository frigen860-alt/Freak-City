...
net.Receive("riot_start", function()
    if RiotSound and IsValid(RiotSound) then
        RiotSound:Stop()
        RiotSound = nil
    end
...
local teams = {
    [0] = {
        objective = "Убей Миграционую службу",
        name = "Мигрант",
        color1 = Color(190,0,0),
        color2 = Color(190,0,0)
    },
    [1] = {
        objective = "Убей Мигрантов",
        name = "Сотрудник Миграционной Службы",
...
if zb.ROUND_START + 8.5 < CurTime() then return end
    ...
    draw.SimpleText("FreakBattle | Riot", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
CreateEndMenu = function()
    ...
    for i, ply in player.Iterator() do
        ...
        but.Paint = function(self, w, h)
            ...
            local status = (not ply:Alive() and " - died") or ""
