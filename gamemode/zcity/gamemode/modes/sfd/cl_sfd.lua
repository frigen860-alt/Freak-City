...
if zb.ROUND_START + 5 > CurTime() then
    ...
    draw.SimpleText("Боксеры 3D", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
